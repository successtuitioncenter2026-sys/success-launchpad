...
const faqs = [
  { q: "Which classes do you teach?", a: "We offer coaching for students from Class 6 to Class 12, covering all major subjects including Mathematics, Science, and Commerce." },
